...
func PostPlantilla(plantilla map[string]interface{}) (plantillaResult map[string]interface{}, outputError interface{}) {
	...
	if err := sendJson(beego.AppConfig.String("evaluacion_crud_url")+"plantilla", "POST", &plantillaPost, plantilla); err != nil {
		logs.Error(err)
...
func GetPlantillasActivas() (plantillaResult []map[string]interface{}, outputError map[string]interface{}) {
	...
	query := "Activo:true"
	if response, err := getJsonTest(beego.AppConfig.String("evaluacion_crud_url")+"plantilla?query="+query, &plantillasGet); (err == nil) && (response == 200) {
...
func DesactivarPlantillas(plantillasActivas []map[string]interface{}) (plantillasResult []map[string]interface{}, outputError map[string]interface{}) {
	...
	for i := 0; i < len(plantillasActivas); i++ {
		...
		if err := sendJson(beego.AppConfig.String("evaluacion_crud_url")+"plantilla/"+fmt.Sprintf("%v", plantillasActivas[i]["Id"]), "PUT", &platillaActualizada, datoContruirdo); err != nil {
			logs.Error(err)
...
func ActivarPlantilla(plantillasParaActivar map[string]interface{}) (plantillasResult map[string]interface{}, outputError map[string]interface{}) {
	...
	if plantillaGet != nil {
		...
		if err := sendJson(beego.AppConfig.String("evaluacion_crud_url")+"plantilla/"+fmt.Sprintf("%v", plantillaGet[0]["Id"]), "PUT", &platillaActualizada, datoContruirdo); err != nil {
			logs.Error(err)
...
func GetPlantilla(plantilla map[string]interface{}) (plantillaResult []map[string]interface{}, outputError map[string]interface{}) {
	...
	if response, err := getJsonTest(beego.AppConfig.String("evaluacion_crud_url")+"plantilla?query="+query, &plantillaGet); (err == nil) && (response == 200) {
